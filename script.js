 ...
 function desenho() {
   ...
   if (estadoAtual == estados.jogar) {
     ...
     contexto.fillText("Dificuldade: " + jogador.dificuldade, 200, 20);
     ...
     jogador.desenho();
     dificuldade();
   } else if (estadoAtual == estados.desafio) {
 ...
 function dificuldade() {
   if (jogador.score >= 0 && jogador.score < 95) {
     ...
     jogador.dificuldade = "Muito Fácil";
   }
   if (jogador.score == 95) {
     balaChefao.y = chefao.y;
     balaChefao.x = chefao.x;
     estadoAtual = estados.desafio;
   } else if (jogador.score > 100 && jogador.score <= 240) {
     inimigo.speed = 2;
     jogador.dificuldade = "Fácil";
   }
   ...
   if (jogador.score == 1440) {
     ...
     inimigo.speed = 8;
     jogador.dificuldade = "Muito Difícil";
   }
